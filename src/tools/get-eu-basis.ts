/**
 * get_eu_basis — Retrieve EU/international legal basis for a Brazilian law.
 *
 * Brazilian laws like LGPD were modeled on EU instruments (GDPR).
 * This tool surfaces those cross-references.
 */
